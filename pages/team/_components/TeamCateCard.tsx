                            ...
                            <div className="card-container">
                                {
                                    data?.members?.map((member: TeamMember) => (
                                        <div key={member.id} className="team-member">
                                            <Image width={300} height={200} style={{ width: "100%", height: "auto" }} src={member.imageUrl} alt={member.name} className="team-member-image" />
                                            <div>
                    ...
                    <div className="card-container">
                        {
                            Array.from({ length: 4 }).map((_, i) => (
                                <div key={i} className="team-member" style={{ height: "300px" }} >
                                    <div>
                                        <div className='people-info'>
                                            <h2><Skeleton /></h2>
